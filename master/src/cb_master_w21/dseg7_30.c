 ...
 * Size: 30 px
 * Bpp: 1
 * Opts: --bpp 1 --size 30 --no-compress --stride 1 --align 1 --font DSEG7Classic-Regular.ttf --symbols  0.123456789.-_+ --format lvgl -o dseg7_30.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1, .adv_w = 392, .box_w = 16, .box_h = 3, .ofs_x = 4, .ofs_y = 14},
    {.bitmap_index = 7, .adv_w = 0, .box_w = 3, .box_h = 4, .ofs_x = -2, .ofs_y = 0},
    {.bitmap_index = 9, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 81, .adv_w = 392, .box_w = 3, .box_h = 27, .ofs_x = 19, .ofs_y = 2},
    {.bitmap_index = 92, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 164, .adv_w = 392, .box_w = 17, .box_h = 30, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 228, .adv_w = 392, .box_w = 19, .box_h = 27, .ofs_x = 3, .ofs_y = 2},
    {.bitmap_index = 293, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 365, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 437, .adv_w = 392, .box_w = 19, .box_h = 29, .ofs_x = 3, .ofs_y = 2},
    {.bitmap_index = 506, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 578, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 650, .adv_w = 392, .box_w = 16, .box_h = 3, .ofs_x = 4, .ofs_y = 0}
};
