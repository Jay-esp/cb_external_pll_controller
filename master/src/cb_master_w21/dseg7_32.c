 ...
 * Size: 32 px
 * Bpp: 1
 * Opts: --bpp 1 --size 32 --no-compress --stride 1 --align 1 --font DSEG7Classic-Regular.ttf --symbols  0.123456789.-_+ --format lvgl -o dseg7_32.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    /* U+005F "_" */
    0x7f, 0xfe, 0x7f, 0xff, 0xbf, 0xff, 0xc0
};
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 89, .adv_w = 418, .box_w = 3, .box_h = 29, .ofs_x = 20, .ofs_y = 2},
    {.bitmap_index = 100, .adv_w = 418, .box_w = 20, .box_h = 32, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 180, .adv_w = 418, .box_w = 18, .box_h = 32, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 252, .adv_w = 418, .box_w = 20, .box_h = 29, .ofs_x = 3, .ofs_y = 2},
    {.bitmap_index = 325, .adv_w = 418, .box_w = 20, .box_h = 32, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 405, .adv_w = 418, .box_w = 20, .box_h = 32, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 485, .adv_w = 418, .box_w = 20, .box_h = 31, .ofs_x = 3, .ofs_y = 1},
    {.bitmap_index = 563, .adv_w = 418, .box_w = 20, .box_h = 32, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 643, .adv_w = 418, .box_w = 20, .box_h = 32, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 723, .adv_w = 418, .box_w = 17, .box_h = 3, .ofs_x = 5, .ofs_y = 0}
};
